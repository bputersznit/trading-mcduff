//
// CG MNQ Scalping Strategy - NT8 NATIVE VERSION v4 - CHART-INDEPENDENT
// NEW v4: Hardcoded bar intervals - does NOT depend on chart settings
// All v3 improvements:
...
{
	public class CGScalpingStrategyNT8Native_v4 : Strategy
	{
		#region Variables
		...
		protected override void OnStateChange()
		{
			...
			{
				Description = @"NT8 Native Order Flow Scalping - v4 CHART-INDEPENDENT";
				Name = "CGScalpingStrategyNT8Native_v4";
			...
			else if (State == State.DataLoaded)
			{
				...
				Print("========================================");
				Print("CG SCALPING NT8 NATIVE v4 - CHART-INDEPENDENT");
				Print("========================================");
		...
		{
			get { return "CG Scalping NT8 Native v4 - Chart Independent"; }
		}
	}
}
