...
// =================================================================================================
// CG_OrderFlow_Aggression_v2_4_REGIME_ACCEPTANCE.cs
...
// -----------------------
// v2.4 restores selective regime gating after v2.3 proved that raw Range-state aggression still loses.
// Default behavior: TrendUp -> longs only, TrendDown -> shorts only, Range -> no trades.
// =================================================================================================

namespace NinjaTrader.NinjaScript.Strategies
{
    public class CG_OrderFlow_Aggression_v2_4_REGIME_ACCEPTANCE : Strategy
    {
        #region Enums
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name = "CG_OrderFlow_Aggression_v2_4_REGIME_ACCEPTANCE";
