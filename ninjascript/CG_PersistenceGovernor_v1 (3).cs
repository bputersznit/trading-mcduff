...
// Full generated file timestamp: 2026-05-08 04:49:00 UTC
//
// MNQ Intraday Strategy — Persistence Governor + Auction Quality + BOS Campaign Upgrade
//
...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class CG_PersistenceGovernor_v1 : Strategy
    {
        ...
        // -----------------------------------------------------------------------------------------
        [NinjaScriptProperty]
        [Display(Name = "Enable Diagnostics", GroupName = "10. Diagnostics", Order = 0)]
        public bool EnableDiagnostics { get; set; }

        [NinjaScriptProperty]
        [Range(1, 1000)]
        [Display(Name = "Diagnostic Print Every N Synthetic Bars", GroupName = "10. Diagnostics", Order = 1)]
