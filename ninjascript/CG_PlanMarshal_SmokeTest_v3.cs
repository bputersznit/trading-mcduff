...
{
    public class CG_PlanMarshal_SmokeTest_v3 : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "CG_PlanMarshal_SmokeTest_v3";
        ...
        private void DPrint(string tag, string message)
        {
            ...
            Print("[CG_PM_SMOKE_V3][" + tag + "] " + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff") + " | " + message);
        }
