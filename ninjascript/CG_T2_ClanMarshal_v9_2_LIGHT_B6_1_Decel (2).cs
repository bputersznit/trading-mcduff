...
// Generated: 2026-05-06 16:05:00 America/New_York
//
// MNQ Intraday Strategy - v9.2 LIGHT B6_1 Decel
//
...
//
// PURPOSE
//   This is the B6.2 logic update while keeping the same B6_1 filename/class.
//   B6.1 restored participation but still faded unstable motion too early.
//   This version adds a lightweight stall gate:
//
//     LONG  requires: no fresh low for N recent ticks before entry.
//     SHORT requires: no fresh high for N recent ticks before entry.
//
// CORE LOGIC
//   LONG:
//     Down impulse -> stall without fresh low -> reclaim -> not straight-line sell acceleration.
//
//   SHORT:
//     Up impulse -> stall without fresh high -> reject -> not straight-line buy acceleration.
//
...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class CG_T2_ClanMarshal_v9_2_LIGHT_B6_1_Decel : Strategy
    {
        ...
        [NinjaScriptProperty]
        [Range(3, 300)]
        [Display(Name = "ImpulseLookbackTicks", GroupName = "02 Signal", Order = 1)]
        ...
        [NinjaScriptProperty]
        [Display(Name = "RequireTurnTick", GroupName = "05 Acceleration", Order = 1)]
        public bool RequireTurnTick { get; set; }

        [NinjaScriptProperty]
        [Range(3, 50)]
        [Display(Name = "AccelerationLookbackTicks", GroupName = "05 Acceleration", Order = 2)]
        public int AccelerationLookbackTicks { get; set; }

        [NinjaScriptProperty]
        [Range(1, 50)]
        [Display(Name = "MaxSameDirectionTicks", GroupName = "05 Acceleration", Order = 3)]
        public int MaxSameDirectionTicks { get; set; }

        [NinjaScriptProperty]
        [Range(0, 100)]
        [Display(Name = "MaxLateReclaimTicks", GroupName = "05 Acceleration", Order = 4)]
        public int MaxLateReclaimTicks { get; set; }

        [NinjaScriptProperty]
        [Range(1, 50)]
        [Display(Name = "StallLookbackTicks", GroupName = "06 StallGate", Order = 1)]
        public int StallLookbackTicks { get; set; }

        [NinjaScriptProperty]
        [Range(1, 50)]
        [Display(Name = "LongNoFreshLowTicks", GroupName = "06 StallGate", Order = 2)]
        public int LongNoFreshLowTicks { get; set; }

        [NinjaScriptProperty]
        [Range(1, 50)]
        [Display(Name = "ShortNoFreshHighTicks", GroupName = "06 StallGate", Order = 3)]
        public int ShortNoFreshHighTicks { get; set; }

        [NinjaScriptProperty]
        [Range(1, 200)]
        [Display(Name = "ProfitTargetTicks", GroupName = "07 Exits", Order = 1)]
        public int ProfitTargetTicks { get; set; }

        [NinjaScriptProperty]
        [Range(1, 200)]
        [Display(Name = "StopLossTicks", GroupName = "07 Exits", Order = 2)]
        public int StopLossTicks { get; set; }

        [NinjaScriptProperty]
        [Range(1, 200)]
        [Display(Name = "EmergencyExitTicks", GroupName = "07 Exits", Order = 3)]
        public int EmergencyExitTicks { get; set; }

        [NinjaScriptProperty]
        [Range(1, 600)]
        [Display(Name = "TimeStopSeconds", GroupName = "07 Exits", Order = 4)]
        public int TimeStopSeconds { get; set; }

        [NinjaScriptProperty]
        [Range(1, 300)]
        [Display(Name = "EarlyFailureSeconds", GroupName = "07 Exits", Order = 5)]
        public int EarlyFailureSeconds { get; set; }

        [NinjaScriptProperty]
        [Range(0, 100)]
        [Display(Name = "EarlyFailureMinProgressTicks", GroupName = "07 Exits", Order = 6)]
        public int EarlyFailureMinProgressTicks { get; set; }

        [NinjaScriptProperty]
        [Range(0, 600)]
        [Display(Name = "CooldownSeconds", GroupName = "08 Governance", Order = 1)]
        public int CooldownSeconds { get; set; }

        [NinjaScriptProperty]
        [Range(1, 100)]
        [Display(Name = "MaxTradesPerDay", GroupName = "08 Governance", Order = 2)]
        public int MaxTradesPerDay { get; set; }

        [NinjaScriptProperty]
        [Range(1, 100)]
        [Display(Name = "MaxEmergencyExits", GroupName = "08 Governance", Order = 3)]
        public int MaxEmergencyExits { get; set; }

        [NinjaScriptProperty]
        [Range(1, 60)]
        [Display(Name = "SideLockoutMinutes", GroupName = "08 Governance", Order = 4)]
        public int SideLockoutMinutes { get; set; }

        [NinjaScriptProperty]
        [Range(1, 60)]
        [Display(Name = "EmergencyFlipLockoutMinutes", GroupName = "08 Governance", Order = 5)]
        public int EmergencyFlipLockoutMinutes { get; set; }

        [NinjaScriptProperty]
        [Range(1, 60)]
        [Display(Name = "AlternationLockoutMinutes", GroupName = "08 Governance", Order = 6)]
        public int AlternationLockoutMinutes { get; set; }

        [NinjaScriptProperty]
        [Range(1, 10)]
        [Display(Name = "AlternatingEmergencyThreshold", GroupName = "08 Governance", Order = 7)]
        public int AlternatingEmergencyThreshold { get; set; }

        [NinjaScriptProperty]
        [Range(0, 100)]
        [Display(Name = "PostExitTickLock", GroupName = "09 AntiRecursion", Order = 1)]
        public int PostExitTickLock { get; set; }

        [NinjaScriptProperty]
        [Range(0, 60000)]
        [Display(Name = "MinMillisecondsBetweenEntries", GroupName = "09 AntiRecursion", Order = 2)]
        public int MinMillisecondsBetweenEntries { get; set; }

        [NinjaScriptProperty]
        [Range(1, 500)]
        [Display(Name = "PendingEntryMaxBars", GroupName = "09 AntiRecursion", Order = 3)]
        public int PendingEntryMaxBars { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "BlockSameBarReentry", GroupName = "09 AntiRecursion", Order = 4)]
        public bool BlockSameBarReentry { get; set; }

        [NinjaScriptProperty]
        [Range(1, 10)]
        [Display(Name = "CascadeEmergencyThreshold", GroupName = "10 Cascade", Order = 1)]
        public int CascadeEmergencyThreshold { get; set; }

        [NinjaScriptProperty]
        [Range(1, 120)]
        [Display(Name = "CascadeWindowMinutes", GroupName = "10 Cascade", Order = 2)]
        public int CascadeWindowMinutes { get; set; }

        [NinjaScriptProperty]
        [Range(1, 120)]
        [Display(Name = "CascadeSuppressMinutes", GroupName = "10 Cascade", Order = 3)]
        public int CascadeSuppressMinutes { get; set; }

        [NinjaScriptProperty]
        [Range(1, 100)]
        [Display(Name = "CascadeContinuationTicks", GroupName = "10 Cascade", Order = 4)]
        public int CascadeContinuationTicks { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "PrintDiagnostics", GroupName = "11 Diagnostics", Order = 1)]
        public bool PrintDiagnostics { get; set; }

        [NinjaScriptProperty]
        [Range(50, 100000)]
        [Display(Name = "DiagnosticEveryTicks", GroupName = "11 Diagnostics", Order = 2)]
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Description = "MNQ LIGHT B6_1 Decel single series tick fade engine with stall gate.";
            ...
            else if (State == State.DataLoaded)
            {
                ...
                if (PrintDiagnostics)
                    Print(Name + " loaded. Use on MNQ 1 tick chart. No AddDataSeries. Stall gate active.");
            }
        }
        ...
        private bool HasNoFreshLow(int barsBack)
        {
            ...
            // True means the current/most recent price is not a fresh low relative to the recent stall window.
        ...
        private bool HasNoFreshHigh(int barsBack)
        {
            ...
            // True means the current/most recent price is not a fresh high relative to the recent stall window.
        ...
        private void MaybePrintDiagnostics(double px, DateTime now)
        {
            ...
            Print(string.Format(
                "{0:yyyy-MM-dd HH:mm:ss} DIAG ticks={1} px={2:F2} pos={3} trades={4} submittedL={5} submittedS={6} Lsetup={7} Ssetup={8} LaccelBlk={9} SaccelBlk={10} LstallBlk={11} SstallBlk={12} sessBlk={13} coolBlk={14} govBlk={15} antiRecBlk={16} pendBlk={17} flipBlk={18}",
                now,
                ticksSeenToday,
                px,
        ...
        {
            Print("------------------------------------------------------------");
            Print(string.Format("{0:yyyy-MM-dd HH:mm:ss} B61 STALL DAILY SUMMARY", now));
            ...
            Print(string.Format("longStallBlocked={0} shortStallBlocked={1}", longStallBlockedToday, shortStallBlockedToday));
