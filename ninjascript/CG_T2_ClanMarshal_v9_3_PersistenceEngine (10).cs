...
// Generated: 2026-05-07 02:24:00 EDT
//
// MNQ ClanMarshal v9.3B PersistenceEngine — VALIDATION BUILD
//
// PURPOSE
// -------
...
// 3. Default PercentileGateMode = P50.
    ...
    public class CG_T2_ClanMarshal_v9_3_PersistenceEngine : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                SyntheticSeconds = 15;
                PercentileGate = CGPercentileGateMode.P50;
        ...
        {
            if (PercentileGate == CGPercentileGateMode.Off)
                return true;

            if (PercentileGate == CGPercentileGateMode.P50)
                return lastSyntheticRange >= Math.Max(TickSize, p50Range);

            if (PercentileGate == CGPercentileGateMode.P80)
        ...
        [NinjaScriptProperty]
        [Display(Name = "PercentileGate", Description = "Percentile gate mode. Off makes it easiest to prove execution. P50 is validation default. P80 is stricter.", Order = 2, GroupName = "01 Synthetic Auction")]
        public CGPercentileGateMode PercentileGate { get; set; }
