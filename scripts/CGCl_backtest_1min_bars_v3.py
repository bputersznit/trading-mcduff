#!/usr/bin/env python3
"""
Backtest using 1-minute aggregated bars - FINAL TUNED VERSION (V3)

Key improvements over v2:
1. WIDER STOPS: $15 trailing (vs $8) - give trades room to breathe
2. LONGER HOLD: 10 bar minimum (vs 5) - avoid quick whips aws
3. LONGER COOLDOWN: 10 bars (vs 5) - wait for clear setups
4. Same regime persistence: 2 consecutive bars
5. Same lookback: 15 bars (15 minutes)

Goal: Reduce overtrading, increase win rate, let winners run
...
def backtest_day(date_str: str, expected_regime: str) -> dict:
    ...
    entry_time = ""
    stop_price = 0.0
    trail_offset = 15.00  # $15 trailing stop - WIDER to avoid whipsaws
    ...
    cooldown_period = 10  # Must wait 10 bars after exit - LONGER cooldown
    min_hold_bars = 10  # Minimum 10 bars to hold position - LONGER holds
...
def main():
    print("\n" + "╔" + "=" * 78 + "╗")
    print("║" + " " * 16 + "1-MINUTE BAR BACKTEST V3 (FINAL TUNED!)" + " " * 22 + "║")
    print("╚" + "=" * 78 + "╝")

    print("\nFinal Tuning (vs v2):")
    print("  • WIDER STOPS: $15 trailing (was $8) - let trades breathe")
    print("  • LONGER HOLD: 10 bar minimum (was 5) - avoid whipsaws")
    print("  • LONGER COOLDOWN: 10 bars (was 5) - wait for clear setups")
    print("  • Regime persistence: 2 consecutive bars")
    print("  • Lookback: 15 bars (15 minutes)")
    print("\nTarget: 5-15 trades on swing days, 1-4 on trend days")
    ...
    print("\n" + "=" * 80)
    print("✅ 1-MINUTE BAR BACKTEST V3 COMPLETE!")
    print("=" * 80)
    print()
