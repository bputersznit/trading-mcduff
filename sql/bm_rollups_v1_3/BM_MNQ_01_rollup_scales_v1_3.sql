...
--   All grouped aggregate builds use inner grouped CTEs with agg_* aliases and
--   outer SELECT projections. This avoids alias-resolution traps that can
--   surface as ILLEGAL_AGGREGATION.
--
-- Run:
