...
--
-- Purpose:
--   QA repaired frame sources after BM_MNQ_03_rebuild_frame_sources_v1_4.sql.
--
-- Expected:
--   total_exec_size in each BM_MNQ_FRAME_SOURCE_* table should now equal the
--   aggression ladder total:
--       36,614,148
--
...
DROP TABLE IF EXISTS BM_MNQ_QA_FRAME_REPAIR_V1_4;

CREATE TABLE BM_MNQ_QA_FRAME_REPAIR_V1_4
ENGINE = MergeTree
...
SELECT
    ...
    heatmap_only_rows,
    joined_rows
FROM BM_MNQ_QA_FRAME_REPAIR_V1_4
