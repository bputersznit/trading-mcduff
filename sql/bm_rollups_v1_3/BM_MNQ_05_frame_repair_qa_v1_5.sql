...
--
-- Purpose:
--   QA batched repaired frame sources after BM_MNQ_run_frame_repair_batched_v1_5.sh.
--
-- Expected:
...
DROP TABLE IF EXISTS BM_MNQ_QA_FRAME_REPAIR_V1_5;

CREATE TABLE BM_MNQ_QA_FRAME_REPAIR_V1_5
ENGINE = MergeTree
...
SELECT
    ...
    heatmap_only_rows,
    joined_rows
FROM BM_MNQ_QA_FRAME_REPAIR_V1_5
