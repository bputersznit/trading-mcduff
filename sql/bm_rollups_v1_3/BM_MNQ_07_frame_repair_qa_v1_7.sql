...
--
-- Purpose:
--   QA frame sources after appending aggression bubbles with v1.7.
--
-- Expected:
...
--
--   aggression_rows should be greater than 0.
--
-- Run:
--   clickhouse-client --multiquery < BM_MNQ_07_frame_repair_qa_v1_7.sql

DROP TABLE IF EXISTS BM_MNQ_QA_FRAME_REPAIR_V1_7;

CREATE TABLE BM_MNQ_QA_FRAME_REPAIR_V1_7
ENGINE = MergeTree
...
SELECT
    ...
    heatmap_only_rows,
    joined_rows
FROM BM_MNQ_QA_FRAME_REPAIR_V1_7
...
SELECT
    ...
    if(aggression_rows > 0, 'PASS', 'CHECK_AGGRESSION_ROWS') AS aggression_rows_check
FROM BM_MNQ_QA_FRAME_REPAIR_V1_7
ORDER BY scale_order;
