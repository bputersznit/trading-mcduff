...
# Double range: 116 points centered on 25236.5
# Price window: ±58 points = ±232 ticks (0.25 tick size)
...
python3 BM_MNQ_render_bookmap_frame_v1_3.py \
  ...
  --fig-width 32 \
  --fig-height 20 \
  --out ./BM_MNQ_1HOUR_DOUBLE_AGGRESSION.png
